...
push @SPECHOOKS, 
 sub {
	...
	&unpack_fc_rpm($jpp,$fcpathRH.'a/apache-commons-el-1.0-24.fc18.noarch.rpm');
	...
	&unpack_fc_rpm($jpp,$fcpathRH.'a/apache-commons-logging-1.1.1-17.fc17.noarch.rpm');
	...
	#&unpack_fc_rpm($jpp,$fcpathRH.'a/apache-commons-io-2.0.1-3.fc16.noarch.rpm');
