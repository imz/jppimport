...
push @SPECHOOKS, 
 sub {
    ...
    $jpp->get_section('package','')->unshift_body('BuildRequires: fastutil5 colt jsap jakarta-commons-lang jakarta-commons-io jakarta-commons-collections jakarta-commons-configuration log4j'."\n");
};

__END__
-export CLASSPATH=%(build-classpath fastutil5 colt jsap jakarta-commons-lang jakarta-commons-io jakarta-commons-collections jakarta-commons-configuration)
+export CLASSPATH=%(build-classpath fastutil5 colt jsap jakarta-commons-lang jakarta-commons-io jakarta-commons-collections jakarta-commons-configuration log4j)
